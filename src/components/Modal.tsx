...
const Modal = () => {
  ...
  return (
    <>
      <button
        className="fixed top-8 right-8 bg-slate-400 px-4 py-1 rounded-sm font-semibold text-gray-50"
            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                <div className="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t text-teal-500">
                  ...
                  <button
                    className="bg-gray-300 hover:bg-gray-150 text-rose-500 background-transparent font-bold uppercase px-6 py-2 text-sm outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                    type="button"
